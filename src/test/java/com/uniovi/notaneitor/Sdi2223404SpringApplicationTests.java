...
class Sdi2223404SpringApplicationTests {
    ...
    //PR06B. Prueba del formulario de registro. Nombre menor que length.
    ...
    //PR06C. Prueba del formulario de registro. Apellidos menor que length.
    // Propiedad: Error.signup.lastName.length
    @Test
    @Order(9)
    public void PR06C() {
        PO_HomeView.clickOption(driver, "signup", "class", "btn btn-primary");
        PO_SignUpView.fillForm(driver, "99999990B", "Josefo", "P", "77777", "77777");
        List<WebElement> result = PO_SignUpView.checkElementByKey(driver, "Error.signup.lastName.length",
                PO_Properties.getSPANISH() );
        //Comprobamos el error de Apellidos cortos de apellidos cortos .
        String checkText = PO_HomeView.getP().getString("Error.signup.lastName.length",
                PO_Properties.getSPANISH());
        Assertions.assertEquals(checkText , result.get(0).getText());
    }

    //PR06D. Prueba del formulario de registro. password menor que length.
    // Propiedad: Error.signup.password.length
    @Test
    @Order(10)
    public void PR06D() {
        PO_HomeView.clickOption(driver, "signup", "class", "btn btn-primary");
        PO_SignUpView.fillForm(driver, "99999990B", "Josefo", "Perez", "7", "77777");
    ...
    public void PR10() {
        ...
        PO_HomeView.clickOption(driver, "login", "class", "btn btn-primary");
        //Rellenamos el formulario
        PO_LoginView.fillLoginForm(driver, "99999990A", "122456");
    ...
    public void PR12() {
        ...
        PO_PrivateView.clickOption(driver, "signup", "text", loginText);
    }
    ...
    public void PR15() {
        ...
        elements = PO_View.checkElementBy(driver, "free", "//td[contains(text(), 'Nota D3')]/following-sibling::*/a[contains(@href,'mark/delete')]");
        elements.get(0).click();
